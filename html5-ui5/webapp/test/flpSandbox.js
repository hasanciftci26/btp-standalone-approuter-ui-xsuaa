		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI 5",
									"targetURL": "#ndbstraininghtml5ui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ndbstraininghtml5ui5-display": {
								"semanticObject": "ndbstraininghtml5ui5",
								"action": "display",
								"description": "UI 5",
								"title": "UI 5",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ndbs.training.html5ui5",
									"url": sap.ui.require.toUrl("ndbs/training/html5ui5")
								}
							}
						}
					}
